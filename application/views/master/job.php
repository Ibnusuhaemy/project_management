  ...
  <section class="content">
    ...
    <div class="box">
      <div class="box-header ">
        ...
        <button onclick="add_job()" class="btn btn-success btn-sm">Add Job</button>
          ...
          <!-- HIDDEN ID -->
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input name="status" id="status1" placeholder="Job" class="form-control" type="text" required>
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    tabeldata = $("#mytable").dataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: {"url": "<?php echo base_url('master/job_datatabel');?>", "type": "POST"},
      columns: 
      [
    ...
    $('.modal-title').text('Add Job'); // Set Title to Bootstrap modal title
  }
  ...
  function edit_job(id)
  {
    ...
    $.ajax({
      url : "<?php echo base_url('master/ajax_edit_job/')?>/" + id,
      type: "GET",
      dataType: "JSON",
      success: function(data)
      {

       $('[name="id"]').val(data.id_job); 
       $('[name="status"]').val(data.nama_job); 
  ...
  function save()
  {
    ...
    if(save_method == 'add') {
      url = "<?php echo site_url('master/ajax_add_job')?>";
    } else {
      url = "<?php echo site_url('master/ajax_update_job')?>";
    }
